	...
	function IB_Entity(_config = {}) : IB_Base(_config) constructor {
		...
		#region scale .............|
			...
			static scale_get_y			   = function(_apply_scale_base = true, _apply_facing = false) {
